...
\end{enumerate}
Figure \ref{fig:micrograph} is a micrograph of a basic Skintillates device, which contains the tattoo substrate and a conductive layer, and is approximately 36\SI{}{\micro\metre}, which is thinner than an average human hair.  Most Skintillates are about the same size as this representation. Surface mount 0603 LEDs and resistors%ADD ARROWS POINTING TO OWL EYES TO SHOW THE LEDS
